...
//	    },
//	)
func (c *Client) GetTrend(ctx context.Context, p GetTrendParams) ([]TrendDataItem, error) {
...
func (c *Client) GetDailySummary(ctx context.Context, p GetDailySummaryParams) ([]DailySummaryItem, error) {
...
func (c *Client) GetRealtimeTrendAppend(ctx context.Context, p GetRealtimeTrendAppendParams) ([]TrendDataItem, error) {
	version := strDefault(p.Version, "-1")
	body := map[string]any{
		"appId":      c.appID,
		"platformId": int(c.platform),
...
func (c *Client) GetHourlyTrend(ctx context.Context, p GetHourlyTrendParams) ([]TrendDataItem, error) {
	version := strDefault(p.Version, "-1")
	body := map[string]any{
		"appId":      c.appID,
		"platformId": int(c.platform),
...
func (c *Client) GetHourlyTopIssues(ctx context.Context, p GetHourlyTopIssuesParams) (*HourlyTopIssuesResponse, error) {
	version := strDefault(p.Version, "-1")
...
func (c *Client) GetDimensionTopStats(ctx context.Context, p GetDimensionTopStatsParams) ([]map[string]any, error) {
...
func (c *Client) GetMinuteCrashData(ctx context.Context, p GetMinuteCrashDataParams) ([]map[string]any, error) {
...
func (c *Client) GetRealTimeAppendStat(ctx context.Context, startHour, endHour string, crashType CrashType) ([]DailySummaryItem, error) {
